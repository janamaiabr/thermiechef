...
const recipes = [
  ["summer-vegetable-pasta-alice-waters", "Summer Vegetable Pasta", "Alice Waters", "summer vegetable pasta", "Dinner", "Californian", "hero-table.jpg"],
  ["crispy-potatoes-j-kenji-lopez-alt", "Crispy Potatoes", "J. Kenji Lopez-Alt", "crispy potatoes", "Dinner", "American", "hero-table.jpg"],
  ["aubergine-curry-meera-sodha", "Aubergine Curry", "Meera Sodha", "aubergine curry", "Dinner", "Indian", "hero-table.jpg"],
  ["pasta-e-ceci-rachel-roddy", "Pasta e Ceci", "Rachel Roddy", "pasta e ceci", "Dinner", "Italian", "hero-table.jpg"],
  ["prawn-toast-dan-hong", "Prawn Toast", "Dan Hong", "prawn toast", "Snack", "Chinese-Australian", "hero-table.jpg"],
  ["mapo-tofu-fuchsia-dunlop", "Mapo Tofu", "Fuchsia Dunlop", "mapo tofu", "Dinner", "Sichuan", "hero-table.jpg"],
  ["yoghurt-cake-dorie-greenspan", "Yoghurt Cake", "Dorie Greenspan", "yoghurt cake", "Baking", "French", "hero-table.jpg"],
  ["lentil-soup-anissa-helou", "Lentil Soup", "Anissa Helou", "lentil soup", "Lunch", "Middle Eastern", "hero-table.jpg"],
  ["ratatouille-elizabeth-david", "Ratatouille", "Elizabeth David", "ratatouille", "Dinner", "French", "hero-table.jpg"],
  ["lemongrass-chicken-luke-nguyen", "Lemongrass Chicken", "Luke Nguyen", "lemongrass chicken", "Dinner", "Vietnamese", "hero-table.jpg"],
].map(([slug, title, chef, dish, category, cuisine], i) => ({
  slug,
  title,
